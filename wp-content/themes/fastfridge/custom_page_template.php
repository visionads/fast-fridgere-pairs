		            ...
		            <?php 
						if ( have_posts() ) :
							while ( have_posts() ) : the_post();
								...
								$post = get_field('custom_pages');
								$posts = get_post_meta($post->ID,'pageposts', true);

								if(!empty($posts)){
									foreach ($posts as $key => $value) {
										$image = wp_get_attachment_image_src($value['post_image'],'full');
					?>

								<?php
									if($value['image_position'] == 'right'){
								?>
									<p>&nbsp;</p>
					                            ...
					                            <div class="wpb_column vc_column_container col-sm-6">
					                                <div class="vc_column-inner ">
					                                    <div class="wpb_wrapper">
					                                        <div class="vc_custom_heading heading-title vc_custom_1439353110248">
					                                ...
					                                <div class="vc_column-inner ">
					                                    <div class="wpb_wrapper">
					                                        <div class="wpb_text_column wpb_content_element ">
					                                            <div class="wpb_wrapper">
					                                                <p><img class="alignnone" src="<?= $image[0]; ?>" alt="" width="570" height="360">
					                                                </p>
